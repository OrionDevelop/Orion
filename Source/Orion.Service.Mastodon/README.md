...
// Register an app.
var app = await client.Apps.RegisterAsync("Test App", "urn:ietf:wg:oauth:2.0:oob", scopes);

// Authorization
// Note: If you set 'scopes' to 'write'/'follow', pass scopes to 3rd argument.
var tokens = await client.OAuth.TokenAsync("YOUR_MAILADDRESS", "YOUR_PASSWORD", scopes);
