...
{
    public class FollowersClient : ApiClient<CroudiaClient>
    {
        internal FollowersClient(CroudiaClient client) : base(client) { }
        ...
        public Task<IdsWithCursor> IdsAsync(string screenName = null, int? userId = null, int? cursor = null)
        {
            ...
            return AppClient.GetAsync<IdsWithCursor>("followers/ids.json", parameters, true);
        }
        ...
        public Task<UsersWithCursor> ListAsync(string screenName = null, int? userId = null, int? cursor = null, bool? trimUser = null)
        {
            ...
            return AppClient.GetAsync<UsersWithCursor>("followers/list.json", parameters, true);
        }
    }
}